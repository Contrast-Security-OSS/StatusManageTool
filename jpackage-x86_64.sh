...
jpackage \
  ...
  --main-class com.contrastsecurity.statusmanagetool.Main \
  ...
  --icon src/main/resources/contrastsecurity.icns \
  --vendor "Contrast Security Japan G.K." \
  --copyright "Copyright (c) 2025 Contrast Security Japan G.K."
